...
*/
CREATE SEQUENCE REPORTUSER.SEQ_AP_EMAIL_TP_TIPO_RECEPTOR
    INCREMENT BY 1
    START WITH 1
    MINVALUE 1
    MAXVALUE 99
    NOCACHE;
CREATE TABLE REPORTUSER.AP_EMAIL_TP_TIPO_RECEPTOR (
  ID NUMBER(2, 0) DEFAULT REPORTUSER.SEQ_AP_EMAIL_TP_TIPO_RECEPTOR.NEXTVAL,
...
CREATE TABLE REPORTUSER.AP_EMAIL_TD_PROY_CORREOS (
  ...
  FOREIGN KEY (ID_TIPO_RECEPTOR) REFERENCES REPORTUSER.AP_EMAIL_TP_TIPO_RECEPTOR (ID),
  FOREIGN KEY (ID_TEMPLATE) REFERENCES REPORTUSER.AP_EMAIL_TP_TEMPLATES (ID)
);
-- ALTER TABLE REPORTUSER.AP_EMAIL_TD_PROY_CORREOS ADD STORE_NO NUMBER(5,0) NULL;
...
CREATE TABLE REPORTUSER.AP_EMAIL_TD_REGISTRO (
  ID NUMBER(18, 0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  FECHA_MENSAJE TIMESTAMP NOT NULL,
  ASUNTO NVARCHAR2(500) NOT NULL,
  DESTINATARIOS NVARCHAR2(500) NOT NULL,
  CON_COPIA NVARCHAR2(500),
  CONTENIDO CLOB NOT NULL,
  ESTADO NVARCHAR2(500),
  DETALLE CLOB,
  PRIMARY KEY (ID)
);
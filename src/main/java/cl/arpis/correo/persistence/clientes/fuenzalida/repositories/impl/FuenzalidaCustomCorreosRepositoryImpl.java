...
import cl.arpis.correo.persistence.clientes.fuenzalida.repositories.ApiUsuariosRepository;
...
@Profile("fuenzalida")
public class FuenzalidaCustomCorreosRepositoryImpl implements CustomCorreosRepository {

	private EntityManager entiManager;
	private Environment env;
	private ApiUsuariosRepository apiUsuariosRepository;

	public FuenzalidaCustomCorreosRepositoryImpl(Environment env,
